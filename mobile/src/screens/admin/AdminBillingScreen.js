...
const createStyles = (colors) => {
  ...
  return StyleSheet.create({
    ...
    roomPillActive: { backgroundColor: colors.card },
    ...
    roomPillTextActive: { color: colors.text },
    ...
    // ─── SUMMARY GRID ───
    summarySection: { marginHorizontal: 16, marginTop: 18 },
    summaryGrid: {
      flexDirection: "row",
      flexWrap: "wrap",
      gap: 8,
    ...
    summaryDot: { width: 8, height: 8, borderRadius: 4, marginBottom: 8 },
    summaryCellLabel: {
      fontSize: 11,
      fontWeight: "800",
      color: colors.textTertiary,
    ...
    summaryCellAmount: { fontSize: 18, fontWeight: "900", color: colors.text },
    totalBar: {
      flexDirection: "row",
      justifyContent: "space-between",
      alignItems: "center",
    ...
    totalBarLabel: { fontSize: 14, fontWeight: "800", color: colors.accent },
    totalBarAmount: { fontSize: 20, fontWeight: "800", color: colors.success },

    // ─── ADMIN TOOLS ───
    toolsSection: { marginHorizontal: 16, marginTop: 20 },
    sectionLabel: {
      fontSize: 11,
      fontWeight: "800",
      color: colors.textTertiary,
    ...
    formCardTitle: { fontSize: 16, fontWeight: "900", color: colors.text },
    editBadge: {
      flexDirection: "row",
      alignItems: "center",
      gap: 4,
    ...
    waterCardTitle: { fontSize: 16, fontWeight: "900", color: colors.text },
    noMembersRow: {
      flexDirection: "row",
      alignItems: "center",
      justifyContent: "center",
