  ...
  return `
      <div style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; color: #333;">
        ...
        <div style="text-align: center; padding: 20px 0; font-size: 12px; color: #888;">
            Reset your Apartment Bill Tracker password!
        </div>
        ...
        <div style="background-color: #ffffff; padding: 30px; text-align: center; border-radius: 8px; margin: 20px 0;">
            ...
            <p style="text-align: left; color: #333;">We received a request to reset your password. To proceed, please enter the following 6-digit verification code:</p>
            ...
            <p style="text-align: left; color: #333;">If you did not request a password reset, please ignore this email or contact support.</p>
        ...
        <div style="font-size: 12px; text-align: left; color: #888; padding: 20px;">
            ...
            <p style="color: #888;">You received this email because a password reset was requested for this account. If this wasn't you, please disregard this message.</p>
