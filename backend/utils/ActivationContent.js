  ...
  return `
      <div style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; color: #333;">
        ...
        <div style="background-color: #ffffff; padding: 30px; text-align: center; border-radius: 8px; margin: 20px 0;">
            ...
            <p style="text-align: left; color: #333;">Thank you for signing up for Shopee Philippines. To complete your registration, please enter the following 6-digit verification code:</p>
            ...
            <p style="text-align: left; color: #333;">If you did not sign up for this account, please ignore this email.</p>
        ...
        <div style="font-size: 12px; text-align: left; color: #888; padding: 20px;">
            ...
            <p style="color: #888;">You received this email because you signed up for a new account. If this wasn't you, you can ignore this message.</p>
