    ...
    <div className="max-w-2xl mx-auto space-y-6 pb-8">
      ...
      <div className="card p-6 space-y-6">
        <Section title="1. Information We Collect">
          ...
          />
          <p className="font-medium text-gray-700 dark:text-white/80 pt-1">
            Usage Data
          </p>
          <Bullets
            items={[
        ...
        <Section title="3. Data Storage & Security">
          <p>
            Your data is stored securely using Supabase (cloud database) with
            row-level security policies. Passwords are hashed using bcrypt.
            Authentication tokens (JWT) are stored securely on your device using
            encrypted storage. We implement industry-standard security measures
        ...
        <Section title="4. Data Sharing">
          <p>
            ...
            Your information may be shared in the following limited
            circumstances:
          </p>
          <Bullets
            items={[
        ...
        <Section title="5. Payment Privacy">
          <p>
            Each member can only view their own payment history and transaction
            details. Administrators can view payment status (paid/unpaid) for
            billing management purposes but individual payment method details
            are kept private.
          </p>
        </Section>
        ...
        <Section title="7. Data Retention">
          <p>
            ...
            Billing history and payment records are kept for record-keeping
            purposes. If you request account deletion, your personal data will
            be removed, though anonymized billing records may be retained for
            the room's accounting integrity.
          </p>
        </Section>
        ...
        <Section title="10. Cookies & Local Storage">
          <p>
            The web app uses browser local storage to save your authentication
            token and preferences. The mobile app uses AsyncStorage and
            SecureStore for the same purpose. No tracking cookies are used.
          </p>
        </Section>
        ...
        <Section title="11. Changes to This Policy">
          <p>
            ...
            communicated through the app. Your continued use of the Service
        ...
        <Section title="12. Contact Us">
          <p>
            ...
            please use the in-app Support page or contact the app administrator.
          </p>
        </Section>
      </div>
    </div>
